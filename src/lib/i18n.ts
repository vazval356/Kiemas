...
const es = {
  ...
  'sub.tagPro': 'Sin ningún tope, para lo que sea',
  ...
  'sub.welcomeTitle': 'Ya es tuyo: {plan}',
...
const en: Record<TranslationKey, string> = {
  ...
  'sub.tagPro': 'No caps at all, for anything',
  ...
  'sub.welcomeTitle': "It's yours: {plan}",
