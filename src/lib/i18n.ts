...
const es = {
  ...
  // Las seis categorías preset de `seed_default_categories` (Supabase): se
  // guardan como texto plano en el idioma con el que se creó el espacio, así
  // que para que se traduzcan al cambiar de idioma hace falta esta tabla
  // aparte. Ver `lib/categories.ts`.
  'category.preset.restaurant': 'Restaurantes',
  'category.preset.park': 'Aire libre',
  'category.preset.sports_tennis': 'Deporte',
  'category.preset.nightlife': 'Noche',
  'category.preset.theater_comedy': 'Cultura',
  'category.preset.more_horiz': 'Otros',
  'place.price': 'Precio',
  'place.notes': 'Notas',
  'place.photos': 'Fotos',
  ...
  'applock.off': 'La app se abre sin pedir nada.',
  'applock.unavailable': 'Tu dispositivo no tiene Face ID, Touch ID ni huella configurados.',
  'applock.promptTitle': 'Desbloquea Kiemas',
  'applock.promptReason': 'Confirma que eres tú para entrar',
  'applock.locked': 'Kiemas está bloqueada',
  'applock.unlock': 'Desbloquear',
  'applock.failed': 'No hemos podido comprobar tu identidad. Inténtalo otra vez.',
...
const en: Record<TranslationKey, string> = {
  ...
  'category.preset.restaurant': 'Dining',
  'category.preset.park': 'Outdoors',
  'category.preset.sports_tennis': 'Sport',
  'category.preset.nightlife': 'Night',
  'category.preset.theater_comedy': 'Culture',
  'category.preset.more_horiz': 'Other',
  'place.price': 'Price',
  'place.notes': 'Notes',
  'place.photos': 'Photos',
  'place.phone': 'Phone',
  ...
  'applock.on': 'Face ID (or your fingerprint) is required to open the app.',
  'applock.off': 'The app opens without asking anything.',
  'applock.unavailable': 'Your device has no Face ID, Touch ID or fingerprint set up.',
  'applock.promptTitle': 'Unlock Kiemas',
  'applock.promptReason': 'Confirm it’s you to get in',
  'applock.locked': 'Kiemas is locked',
  'applock.unlock': 'Unlock',
  'applock.failed': 'We couldn’t confirm it’s you. Try again.',
