...
const es = {
  ...
  'space.mySpaceColor': 'Mi color para este espacio',
  'space.mySpaceColorHint': 'Solo lo ves tú. El color del grupo no cambia para los demás.',
...
const en: Record<TranslationKey, string> = {
  ...
  'space.mySpaceColor': 'My colour for this space',
  'space.mySpaceColorHint': 'Only you see it. The group colour does not change for anyone else.',
